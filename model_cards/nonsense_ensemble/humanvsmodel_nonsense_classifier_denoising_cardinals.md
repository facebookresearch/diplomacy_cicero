...
This is a Transformer-based classifier model used to discriminate between human and model-generated text, used in an ensemble of nonsense classifiers inside Cicero. The model generated negatives are provided by a denoising model that was trained on Diplomacy messages with a number-related word and was guaranteed to mask the number word among other words or tokens.

This model was developed by Meta AI. Training began on 2022-07-31.
...
S1904M
[...]
GERMANY -> ENGLAND: What would it take for us to work together?
S1903M
...
ENGLAND -> GERMANY: We'd need 4 builds.
...
This model filtered 4.80% of messages in live games.
...
<summary> Hyperparameters </summary>
 ...
 - `image_size`: `256`
 - `image_cropsize`: `224`
 - `model_generated_messages`: `denoising_cardinals`
