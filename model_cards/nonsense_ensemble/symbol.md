...
This is a Transformer-based classifier model used to predict whether a dialogue message contains a corrupted "symbol", or abbreviation of a location (e.g. PAR, which represents Paris).
...
S1901M
England -> France: Sure, will you move to BUL? [EO_M]
...
This model filtered 2.65% of messages in live games.
...
<summary> Hyperparameters </summary>
 ...
 - `entity_corruption_types`: `symbols`
 - `beam_size`: `1`
 - `beam_min_length`: `1`
