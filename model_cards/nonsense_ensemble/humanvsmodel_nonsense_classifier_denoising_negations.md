...
This is a Transformer-based classifier model used to discriminate between human and model-generated text, used in an ensemble of nonsense classifiers inside Cicero. The model generated negatives are provided by a denoising model that was trained on Diplomacy messages with a grammatical negation or similar word, and was guaranteed to mask the negating word among other words or tokens.
...
S1904M
[...]
GERMANY -> ENGLAND: You stabbed me!
S1903M
...
ENGLAND -> GERMANY: I didn't stab you.
...
This model filtered 7.58% of messages in live games.
...
<summary> Hyperparameters </summary>
 ...
 - `image_size`: `256`
 - `image_cropsize`: `224`
 - `model_generated_messages`: `denoising_negations`
