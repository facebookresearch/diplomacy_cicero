...
This is a Transformer-based classifier model used to discriminate between human and model-generated text (where the model generated negatives are provided by a "weak" generative dialogue model fine-tuned for Diplomacy), used in an ensemble of nonsense classifiers inside Cicero.

This model was developed by Meta AI. Training began on December 31, 2021.
...
```
[input]: units: S1901M
England -> France: Wanna work together? [EO_M] [EO_M] units: Austria: A BUD, A VIE, F TRI; England: A LVP, F EDI, F LON; France: A MAR, A PAR, F BRE; Germany: A BER, A MUN, F KIE; Italy: A ROM, A VEN, F NAP; Russia: A MOS, A WAR, F SEV, F STP/SC; Turkey: A CON, A SMY, F ANK [EO_STATE] S1901M England: England -> France: Hello France! [EO_M]
...
This model was trained using the WebDiplomacy dataset, described in the [paper](https://www.science.org/doi/10.1126/science.ade9097). We used a "weak" generative dialogue model trained for Diplomacy to provide model-generated counterfactuals.
...
This model filtered 18.08% of messages in live games.
...
<summary> Hyperparameters </summary>
 ...
 - `task`: `message_history_shortstate_humanvsmodeldiscriminator_chunk`
 - `datatype`: `train`
 - `hide_labels`: `False`
 - `multitask_weights`: `[1]`
 - `batchsize`: `10`
 ...
 - `evaltask`: `message_history_shortstate_humanvsmodeldiscriminator_chunk`
 - `final_extra_opt`: ``
 - `eval_batchsize`: `None`
 ...
 - `image_size`: `256`
 - `image_cropsize`: `224`
 - `model_generated_messages`: `shortcontext`
