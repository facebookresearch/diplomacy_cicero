...
This is a Transformer-based classifier model used to discriminate between human and model-generated text, used in an ensemble of nonsense classifiers inside Cicero. The model generated negatives are provided by removing between a random number of messages (between 1 and 3) from an example's most recent message history, such that the proposed message appears to be a non-sequitur with respect to the message history visible to the model.

This model was developed by Meta AI. Training began on 2022-07-30.
...
S1904M
[...]
AUSTRIA -> GERMANY: Want to work together?
F1904M
...
AUSTRIA: A BUD S A VIE; A GRE S A SER; A ROM VEN; A SER S A BUD; A TRI S A TYR; A TYR S A VIE; A VIE S A BUD; F ION AEG; F TUN WES
GERMANY: A BER SIL; A BOH TYR; A BUR MAR; A MAR PIE; A MUN S A BOH TYR; A RUH BUR; F DEN H; F SKA H
S1905M GERMANY NON-ANON 1440min PPSC ALL-UNK PUBLIC NODRAWS:
AUSTRIA: That's just the way things are.
...
This model filtered 1.18% of messages in live games.
...
<summary> Hyperparameters </summary>
 ...
 - `task`: `real_message_history_orderhistorysincelastmovementphase_shortstate_pseudoorder_dialoguediscriminator_chunk,nonsequitur_message_history_orderhistorysincelastmovementphase_shortstate_pseudoorder_dialoguediscriminator_chunk`
 - `datatype`: `train`
 - `hide_labels`: `False`
 - `multitask_weights`: `[1]`
 - `batchsize`: `2`
 ...
 - `evaltask`: `real_message_history_orderhistorysincelastmovementphase_shortstate_pseudoorder_dialoguediscriminator_chunk,nonsequitur_message_history_orderhistorysincelastmovementphase_shortstate_pseudoorder_dialoguediscriminator_chunk`
 - `final_extra_opt`: ``
 - `eval_batchsize`: `None`
 ...
 - `lowercase_judgement_message`: `False`
 - `beam_size`: `1`
 - `beam_min_length`: `1`
